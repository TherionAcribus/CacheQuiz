...
from admin_validation import (
    admin_validation_page,
    list_pending_questions,
    list_pending_quiz_rules,
    approve_question_validation,
    reject_question_validation,
    confirm_approve_question_validation,
    confirm_reject_question_validation,
    confirm_approve_quiz_rule_validation,
    confirm_reject_quiz_rule_validation,
    approve_quiz_rule_validation,
    reject_quiz_rule_validation,
)
...
app.add_url_rule('/api/admin/validation/quiz-rule/<int:rule_id>/approve/confirm', 'confirm_approve_quiz_rule_validation', confirm_approve_quiz_rule_validation, methods=['GET'])
app.add_url_rule('/api/admin/validation/quiz-rule/<int:rule_id>/reject/confirm', 'confirm_reject_quiz_rule_validation', confirm_reject_quiz_rule_validation, methods=['GET'])
app.add_url_rule('/api/admin/validation/quiz-rule/<int:rule_id>/approve', 'approve_quiz_rule_validation', approve_quiz_rule_validation, methods=['POST'])
app.add_url_rule('/api/admin/validation/quiz-rule/<int:rule_id>/reject', 'reject_quiz_rule_validation', reject_quiz_rule_validation, methods=['POST'])
